...
public class DeflaterResponseWrapper extends HttpServletResponseWrapper {
    protected HttpServletResponse servletResponse;
    protected ServletOutputStream outputStrem;
    protected PrintWriter printWriter;

    public DeflaterResponseWrapper(HttpServletResponse httpservletresponse) {
    ...
    public ServletOutputStream createOutputStream() throws IOException {
        return new DeflaterResponseStream(servletResponse);
    }
