...
public class PermissionExporter extends Exporter<Permission>{
	...
	@Override
	public void csvExporter(List<Permission> results) throws IOException,
			IllegalAccessException, NoSuchMethodException, SAXException,
			IntrospectionException, NoSuchFieldException,
			InvocationTargetException {
		
		HttpServletResponse response = getResponse();
		
		String fileName = "Permission.csv";
	...
	public void pdfExporter(List<Permission> results) throws DocumentException, IOException, IntrospectionException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, NoSuchFieldException{
		HttpServletResponse response = getResponse();
		
		String fileName = "Permission.pdf";
	...
	public void xmlExporter(List<Permission> results) throws DocumentException, IOException, IntrospectionException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, NoSuchFieldException{
		HttpServletResponse response = getResponse();
	...
	public void xlsExporter(List<Permission> results) throws DocumentException, IOException, IntrospectionException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, NoSuchFieldException{
		HttpServletResponse response = getResponse();
		
		String fileName = "Permission.xls";
