...
public class UserExporter extends Exporter<User>{
	...
	@Override
	public void csvExporter(List<User> results) throws IOException,
	...
	@Override
	public void pdfExporter(List<User> results) throws DocumentException,
	...
	@Override
	public void xlsExporter(List<User> results) throws DocumentException,
			IOException, IntrospectionException, NoSuchMethodException,
			IllegalAccessException, InvocationTargetException,
			NoSuchFieldException {
		HttpServletResponse response = getResponse();
	...
	@Override
	public void xmlExporter(List<User> results) throws DocumentException,
			IOException, IntrospectionException, NoSuchMethodException,
			IllegalAccessException, InvocationTargetException,
			NoSuchFieldException {
		HttpServletResponse response = getResponse();
